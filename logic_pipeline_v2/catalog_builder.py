...
Builds a lightweight catalog for the v2 logic pipeline layout. Summaries are
...
def build_catalog(cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    combined_root = Path(g.get("combined_root", "/data/logic/combined"))
    final_root = Path(g.get("final_root", "/data/logic/final"))
