...
Usage:
  python catalog_builder.py --targets targets_logic.yaml --output /data/logic/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    ap.add_argument("--targets", required=True, help="targets_logic.yaml")
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/logic/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/logic/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/logic/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/logic/_manifests")).expanduser()
