...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/math/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/math/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/math/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/math/_manifests")).expanduser()
