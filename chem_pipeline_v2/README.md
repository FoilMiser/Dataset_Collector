...
./run_pipeline.sh --targets targets_chem.yaml --stage classify
...
- YELLOW screening enforces "anything unclear is pitched"; see `targets_chem.yaml -> globals.screening` and per-target `yellow_screen` overrides.
