...
Deprecated compatibility shim for `dc run --pipeline engineering --stage acquire`.
Removal target: v4.0.
"""
...
DOMAIN = "engineering"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline engineering --stage acquire` instead. "
    "Removal target: v4.0."
)
