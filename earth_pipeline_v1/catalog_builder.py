...
Usage:
  python catalog_builder.py --targets targets.yaml --output /data/earth/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/earth/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/earth/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/earth/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/earth/_manifests")).expanduser()
