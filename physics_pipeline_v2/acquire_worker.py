...
Deprecated compatibility shim for `dc run --pipeline physics --stage acquire`.
Removal target: v4.0.
"""
...
DOMAIN = "physics"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline physics --stage acquire` instead. "
    "Removal target: v4.0."
)
