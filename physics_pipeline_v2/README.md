...
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage classify

# Acquire GREEN and YELLOW (execute downloads)
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage acquire_green --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage acquire_yellow --execute

# Screen, merge, catalog
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage screen_yellow --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage merge --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_physics.yaml --stage catalog
```
