...
Builds a lightweight catalog for the v2 physics pipeline layout. Summaries are
...
def build_catalog(cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    combined_root = Path(g.get("combined_root", "/data/physics/combined"))
    final_root = Path(g.get("final_root", "/data/physics/final"))
...
def main() -> None:
    ...
    ap.add_argument("--targets", required=True, help="targets_physics.yaml")
