...
Deprecated compatibility shim for `dc run --pipeline biology --stage acquire`.
Removal target: v3.0.
"""
...
DOMAIN = "biology"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline biology --stage acquire` instead. "
    "Removal target: v3.0."
)
