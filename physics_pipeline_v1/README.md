...
# or:
python3 review_queue.py --queue /data/physics/_queues/yellow_pipeline.jsonl list
```
...
### Build catalog
```bash
python3 catalog_builder.py --targets targets.yaml --output /data/physics/_catalogs/global_catalog.json
```
