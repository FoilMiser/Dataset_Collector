...
The recommended roots live in `../pipelines/targets/targets_math.yaml -> globals`:
...
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage classify

# Acquire GREEN and YELLOW (execute downloads)
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage acquire_green --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage acquire_yellow --execute

# Screen, merge, catalog
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage screen_yellow --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage merge --execute
./run_pipeline.sh --targets ../pipelines/targets/targets_math.yaml --stage catalog
```

### Notes

- YELLOW screening enforces "anything unclear is pitched"; see `../pipelines/targets/targets_math.yaml -> globals.screening` and per-target `yellow_screen` overrides.
