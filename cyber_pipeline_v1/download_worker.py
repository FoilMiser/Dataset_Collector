...
ftp_spec = importlib.util.find_spec("ftplib")
FTP = importlib.import_module("ftplib").FTP if ftp_spec else None

datasets_spec = importlib.util.find_spec("datasets")
datasets_mod = importlib.import_module("datasets") if datasets_spec else None
...
def main() -> None:
    ...
    ap.add_argument("--pools-root", default="/data/cyber/pools", help="Fallback pools root")
    ap.add_argument("--logs-dir", default="/data/cyber/_logs", help="Logs directory")
