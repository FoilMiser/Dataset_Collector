...
Builds a lightweight catalog for the v2 regcomp pipeline layout. Summaries are
...
def build_catalog(cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    combined_root = Path(g.get("combined_root", "/data/regcomp/combined"))
    final_root = Path(g.get("final_root", "/data/regcomp/final"))
...
def main() -> None:
    ...
    ap.add_argument("--targets", required=True, help="targets_regcomp.yaml")
