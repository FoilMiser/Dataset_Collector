...
Deprecated compatibility shim for `dc run --pipeline regcomp --stage acquire`.
Removal target: v4.0.
"""
...
DOMAIN = "regcomp"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline regcomp --stage acquire` instead. "
    "Removal target: v4.0."
)
