...
Deprecated compatibility shim for `dc run --pipeline metrology --stage acquire`.
Removal target: v4.0.
"""
...
DOMAIN = "metrology"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline metrology --stage acquire` instead. "
    "Removal target: v4.0."
)
