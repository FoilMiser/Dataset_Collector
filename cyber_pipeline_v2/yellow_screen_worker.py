...
def resolve_roots(cfg: dict[str, Any]) -> Roots:
    ...
    return Roots(
        raw_root=Path(g.get("raw_root", "/data/cyber/raw")),
        screened_root=Path(g.get("screened_yellow_root", "/data/cyber/screened_yellow")),
        manifests_root=Path(g.get("manifests_root", "/data/cyber/_manifests")),
