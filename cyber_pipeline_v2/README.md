...
dc pipeline cyber -- --targets ../pipelines/targets/targets_cyber.yaml --stage classify --no-fetch

# Acquire GREEN and YELLOW (execute downloads)
dc run --pipeline cyber --stage acquire --allow-data-root -- --queue /data/cyber/_queues/green_pipeline.jsonl --bucket green --targets-yaml ../pipelines/targets/targets_cyber.yaml --execute
dc run --pipeline cyber --stage acquire --allow-data-root -- --queue /data/cyber/_queues/yellow_pipeline.jsonl --bucket yellow --targets-yaml ../pipelines/targets/targets_cyber.yaml --execute

# Screen, merge, catalog
dc run --pipeline cyber --stage yellow_screen --allow-data-root -- --queue /data/cyber/_queues/yellow_pipeline.jsonl --targets ../pipelines/targets/targets_cyber.yaml --execute
dc run --pipeline cyber --stage merge --allow-data-root -- --targets ../pipelines/targets/targets_cyber.yaml --execute
dc catalog-builder --pipeline cyber --allow-data-root -- --targets ../pipelines/targets/targets_cyber.yaml --output /data/cyber/_catalogs/catalog.json
```
