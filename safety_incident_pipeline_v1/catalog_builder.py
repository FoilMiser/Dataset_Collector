...
Usage:
  python catalog_builder.py --targets targets.yaml --output /data/safety/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/safety/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/safety/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/safety/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/safety/_manifests")).expanduser()
