...
Usage:
    python catalog_builder.py --targets targets.yaml --output /data/econ/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/econ/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/econ/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/econ/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/econ/_manifests")).expanduser()
