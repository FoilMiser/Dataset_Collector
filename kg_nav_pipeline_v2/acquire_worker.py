...
Deprecated compatibility shim for `dc run --pipeline kg_nav --stage acquire`.
Removal target: v4.0.
"""
...
DOMAIN = "kg_nav"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline kg_nav --stage acquire` instead. "
    "Removal target: v4.0."
)
