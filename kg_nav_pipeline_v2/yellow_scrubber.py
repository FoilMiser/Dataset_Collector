...
This script performs a light YELLOW review planning pass for KG navigation data.
It is intentionally conservative; deeper transforms occur in specialized workers.
...
Usage examples:
    python yellow_scrubber.py --targets targets_kg_nav.yaml
    python yellow_scrubber.py --targets targets_kg_nav.yaml --limit 20 --output /tmp/yellow_plan.json
...
def main() -> None:
    ...
    queues_root = Path(cfg.get("globals", {}).get("queues_root", "/data/kg_nav/_queues")).expanduser()
