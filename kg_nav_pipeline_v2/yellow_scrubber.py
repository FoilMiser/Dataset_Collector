"""
KG navigation pipeline helper for YELLOW bucket planning and manual review prep.

This script does **not** perform domain-specific transforms yet (future workers
