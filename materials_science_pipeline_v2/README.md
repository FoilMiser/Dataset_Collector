...
./run_pipeline.sh --targets targets_materials.yaml --stage acquire_yellow --execute

# Screen, merge, catalog
./run_pipeline.sh --targets targets_materials.yaml --stage screen_yellow --execute
./run_pipeline.sh --targets targets_materials.yaml --stage merge --execute
./run_pipeline.sh --targets targets_materials.yaml --stage catalog
```

### Notes

- YELLOW screening enforces "anything unclear is pitched"; see `targets_materials.yaml -> globals.screening` and per-target `yellow_screen` overrides.
