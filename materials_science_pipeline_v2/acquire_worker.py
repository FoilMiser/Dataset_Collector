...
Deprecated compatibility shim for `dc run --pipeline materials_science --stage acquire`.
Removal target: v4.0.
"""
...
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline materials_science --stage acquire` instead. "
    "Removal target: v4.0."
)
