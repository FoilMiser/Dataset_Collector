...
The recommended roots live in `targets_econ_stats_decision_v2.yaml -> globals`:
...
./run_pipeline.sh --targets targets_econ_stats_decision_v2.yaml --stage acquire_yellow --execute

# Screen, merge, difficulty, catalog
./run_pipeline.sh --targets targets_econ_stats_decision_v2.yaml --stage screen_yellow --execute
./run_pipeline.sh --targets targets_econ_stats_decision_v2.yaml --stage merge --execute
./run_pipeline.sh --targets targets_econ_stats_decision_v2.yaml --stage difficulty --execute
./run_pipeline.sh --targets targets_econ_stats_decision_v2.yaml --stage catalog
```

### Notes

- YELLOW screening enforces "anything unclear is pitched"; see `targets_econ_stats_decision_v2.yaml -> globals.screening` and per-target `yellow_screen` overrides.
