...
Builds a lightweight catalog for the v2 econ/stats/decision pipeline layout.
Summaries are organized by stage (raw, screened_yellow, combined, final) and by
license pool when applicable.
"""
