...
Deprecated compatibility shim for `dc run --pipeline 3d_modeling --stage acquire`.
Removal target: v3.0.
"""
...
DOMAIN = "3d_modeling"
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline 3d_modeling --stage acquire` instead. "
    "Removal target: v3.0."
)
