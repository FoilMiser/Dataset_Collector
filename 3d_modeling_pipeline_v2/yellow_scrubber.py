"""
3D modeling pipeline helper for YELLOW bucket planning and manual review prep.

This script does **not** perform mesh transforms; it only:
...
Usage examples:
    python yellow_scrubber.py --targets targets_3d.yaml
    python yellow_scrubber.py --targets targets_3d.yaml --limit 20 --output /tmp/yellow_plan.json
...
def main() -> None:
    ...
    queues_root = Path(cfg.get("globals", {}).get("queues_root", "/data/3d/_queues")).expanduser()
