...
def resolve_roots(cfg: dict[str, Any]) -> Roots:
    ...
    return Roots(
        ...
        manifests_root=Path(g.get("manifests_root", "/data/earth/_manifests")),
        ledger_root=Path(g.get("ledger_root", "/data/earth/_ledger")),
        pitches_root=Path(g.get("pitches_root", "/data/earth/_pitches")),
    )
...
def canonical_record(raw: dict[str, Any], text: str, target_id: str, license_profile: str, license_spdx: Optional[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "routing": raw.get("routing") or raw.get("earth_routing") or raw.get("math_routing") or raw.get("route") or {},
