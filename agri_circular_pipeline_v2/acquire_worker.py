...
Deprecated compatibility shim for `dc run --pipeline agri_circular --stage acquire`.
Removal target: v4.0.
"""
...
DEPRECATION_MESSAGE = (
    "acquire_worker.py is deprecated; use `dc run --pipeline agri_circular --stage acquire` instead. "
    "Removal target: v4.0."
)
