...
Usage examples:
    python yellow_scrubber.py --targets targets_nlp.yaml
    python yellow_scrubber.py --targets targets_nlp.yaml --limit 20 --output /tmp/yellow_plan.json
...
def main() -> None:
    ap = argparse.ArgumentParser(description="NLP pipeline YELLOW review helper")
    ...
    queues_root = Path(cfg.get("globals", {}).get("queues_root", "/data/nlp/_queues")).expanduser()
    ...
    print("NLP YELLOW queue summary")
