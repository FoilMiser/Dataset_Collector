...
Usage:
  python catalog_builder.py --targets targets.yaml --output /data/bio/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/bio/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/bio/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/bio/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/bio/_manifests")).expanduser()
