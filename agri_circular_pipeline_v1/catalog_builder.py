...
Usage:
  python catalog_builder.py --targets targets.yaml --output /data/agri_circular/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/agri_circular/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/agri_circular/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/agri_circular/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/agri_circular/_manifests")).expanduser()
