...
Usage:
  python catalog_builder.py --targets targets.yaml --output /data/kg_nav/_catalogs/global_catalog.json
...
def main() -> None:
    ...
    permissive_root = Path(pools_cfg.get("permissive", "/data/kg_nav/pools/permissive")).expanduser()
    copyleft_root = Path(pools_cfg.get("copyleft", "/data/kg_nav/pools/copyleft")).expanduser()
    quarantine_root = Path(pools_cfg.get("quarantine", "/data/kg_nav/pools/quarantine")).expanduser()
    manifests_root = Path(globals_cfg.get("manifests_root", "/data/kg_nav/_manifests")).expanduser()
